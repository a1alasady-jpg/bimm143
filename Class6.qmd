...
Functions are at the heart of using R. Everything we do involves calling and using functions (from data input, anaylysis to results output).

All functions in R have at least 3 things:

1. A **name** the thing we use to call the function.
2. One or more input **arguments** that a are comma seperated 
...
> **N.B.** Input arguments can be either **required** or **optional**. The later have a fall back deafult that is specifed in the function code with an equals sign.
...
> Q. Return 12 numbers picked ramdomly from the input 1:10
...
> Q. Write a function called `generate_protein()` that generates a user specified length protien sequence in FASTA like format?
...
> Q. Use your new `generate_protien()` function to generate sequences between length 6 and 12 amino acids in length and check of any these are unique in nature (i.e found in the NR database at NCBI)?
